...
# venuegeners = db.Table('venuegeners',
#   db.Column('gener_id',db.Integer, db.ForeignKey('geners.id'), primary_key=True),
#   db.Column('venue_id', db.Integer, db.ForeignKey('venue.id'), primary_key=True))


# artistgeners = db.Table('artistgeners',
#   db.Column('gener_id', db.Integer, db.ForeignKey('geners.id'), primary_key=True),
...
class VenueGeners(db.Model):
  ...
  vanue_id = db.Column(db.Integer, db.ForeignKey('venue.id'), primary_key=True)
...
class Venue(db.Model):
    ...
    geners = db.relationship('VenueGeners', backref='venue', lazy=True, cascade="all, delete, delete-orphan")
    shows = db.relationship('Shows', back_populates = 'venue', cascade="all, delete, delete-orphan")
...
class Artist(db.Model):
    ...
    seeking_description = db.Column(db.String(500), nullable=True)
    shows = db.relationship('Shows', back_populates = 'artist', cascade="all, delete, delete-orphan")
    geners = db.relationship('ArtistGeners', backref='artist', lazy=True, cascade="all,, delete, delete-orphan")
    # TODO: implement any missing fields, as a database migration using Flask-Migrate
